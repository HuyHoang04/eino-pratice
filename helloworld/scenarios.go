...
var scenarios = []scenario{
	...
	{
		Name:        "autofill_vi",
		Description: "Seeded customer (Lan) -> search_crm_database auto-fills fields, no re-ask.",
		Turns: []string{
			"chào shop, mình là Lan, mình nghe nói bên mình có CRM hay, tư vấn cho mình với",
			"bên mình tầm 15 người, đang tính đổi hệ thống",
		},
	},
	{
		Name:        "refuse_phone_vi",
		...
		Turns: []string{
			...
			"mình không muốn cho số điện thoại đâu, mình ngại lắm",
			"ok vậy mình cho email hung@salesco.com nha",
		},
	},
	{
		Name:        "dodge_vi",
		Description: "Customer dodges the contact question (asks about price) -> steer back.",
		Turns: []string{
			"chào, mình là Tuấn bên công ty vận tải, mình cần tìm CRM quản lý khách hàng",
			"nhà mình gói rẻ nhất giá bao nhiêu, có dùng thử miễn phí không",
			"tuan@transport.vn",
		},
	},
	{
		Name:        "skeptical_vi",
		Description: "Customer pushes back on sharing phone -> justify + offer email.",
		Turns: []string{
			"chào, mình là Mai bên công ty bất động sản, đang muốn đổi hệ thống CRM",
			"tại sao mình phải cho số điện thoại, mình không tiện chia sẻ lắm",
			"ok vậy mình cho email mai@real.vn nha",
		},
	},
	{
		Name:        "handoff_vi",
